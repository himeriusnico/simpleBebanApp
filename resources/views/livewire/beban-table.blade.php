<div x-data="{ openForm: false }">
    ...
    {{-- <div class="flex items-center justify-between mb-6">
        ...
        <button @click="showForm = !showForm" class="px-4 py-2 bg-blue-600 text-white rounded-lg">
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-lg font-semibold text-gray-800">Daftar Beban</h2>
        <button class="px-4 py-2 bg-blue-600 text-white rounded-lg" @click="openForm = !openForm"> {{-- reminder @click
            itu x-on, syntax pendek --}}
            <span x-show="!openForm">+ Tambah Beban</span>
            <span x-show="openForm">Tutup Form</span>
        </button>
    </div> {{-- gaya alpine --}}

    {{-- <div x-show="$wire.showForm" class="bg-white border border-gray-200 rounded-xl p-6 mb-6"> --}}
        <div x-show="openForm" class="bg-white border border-gray-200 rounded-xl p-6 mb-6"> {{-- Ini gaya
            alpine, masalahnya karena ada function livewire this showform otomatis ga sinkron --}}
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <button wire:click="edit({{ $beban->id }})" @click="openForm = true"
